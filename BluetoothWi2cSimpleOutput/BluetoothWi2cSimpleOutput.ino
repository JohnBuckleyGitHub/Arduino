...
void loop()
{
    ...
    // char outstr3[7];
    char outstrT[10];
    dtostrf(fP1,8,2,outstr1);
    // dtostrf(fP2,7,2,outstr2);
    // dtostrf(diff,7,2,outstr3);
    dtostrf(tNow,10,0,outstrT);
    String str1=outstr1;
    // String str2=outstr2;
    // String str3=outstr3;
    String strT=outstrT;
    ...
    String strResult = "[t" + strT + " a" + str1 + "]"; // String length 23 char, 2 + 10 + 2 + 8 + 1
